...
import com.fl.test.utils.file.FileUtils;
import com.fl.test.utils.logUtils.L;
...
public class BitmapUtils {
    ...
    public static Bitmap blur(Context context, Bitmap sentBitmap, int radius) {
        ...
        if (radius < 0) {
            radius = 0;
            if (DEBUG) {
                L.i(TAG, "radius must be 0 < r < 25 , forcing radius=0");
            }
        } else if (radius > 25) {
            radius = 25;
            if (DEBUG) {
                L.i(TAG, "radius must be 0 < r < 25 , forcing radius=25");
            }
        }
